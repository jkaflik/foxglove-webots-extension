import defaultThumbnailUrl from './images/loading/default_thumbnail.png';
import webotsLogoUrl from './images/icons/webots-view.svg';
...
export default class Progress {
  ...
  constructor(parentNode, message, image) {
    ...
    this.#progressPanelTitle.innerHTML = `<img src="${webotsLogoUrl}"></img><p>Webots</p>`;
  ...
  #setDefaultImage() {
    this.#progressImage.src = defaultThumbnailUrl;
  }
}
